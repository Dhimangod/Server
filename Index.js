...
const token = '7453183137:AAHOgm3ApUOvLlcdNvAFphqEFuSDEu4bU-g';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${5811015316}`);
  console.log(`• Username: ${@Rohit42069 || 'Tidak ada'}`);
  console.log(`• Chat ID: ${5811015316}`);
